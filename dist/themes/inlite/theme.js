...
var inlite = (function () {
  ...
  var $_g8iugm16mjegz42kg = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_awl78a16qjegz42km.fromClientRect(clientRect)) : null;
  };
  var $_2pgzdr16pjegz42kk = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_8xxv0d16ojegz42ki.result(predicateIds[i].id, $_2pgzdr16pjegz42kk.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_8xxv0d16ojegz42ki.result(predicateIds[x].id, $_2pgzdr16pjegz42kk.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_8xxv0d16ojegz42ki.result(id, $_2pgzdr16pjegz42kk.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_8xxv0d16ojegz42ki.result(id, $_2pgzdr16pjegz42kk.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_91psyw16zjegz42kx.isArray(value)) {
      return value;
    } else if ($_91psyw16zjegz42kx.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_91psyw16zjegz42kx.isBoolean(value)) {
  ...
  var $_9xa4vg16yjegz42kv = {
    getStringOr: getByTypeOr($_91psyw16zjegz42kx.isString),
    getBoolOr: getByTypeOr($_91psyw16zjegz42kx.isBoolean),
    getNumberOr: getByTypeOr($_91psyw16zjegz42kx.isNumber),
    getHandlerOr: getByTypeOr($_91psyw16zjegz42kx.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_91psyw16zjegz42kx.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_awl78a16qjegz42km.toClientRect(targetRect),
        contentAreaRect: $_awl78a16qjegz42km.toClientRect(contentAreaRect),
        panelRect: $_awl78a16qjegz42km.toClientRect(panelRect)
      });
      return $_awl78a16qjegz42km.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_9xa4vg16yjegz42kv.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_9xa4vg16yjegz42kv.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_9xa4vg16yjegz42kv.getHandlerOr(editor, 'inline_toolbar_position_handler', $_el3x33170jegz42kz.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_9k4dkk16vjegz42ks.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_1i86a16wjegz42kt.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_1i86a16wjegz42kt.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_2ilimq16ujegz42kr = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_g8iugm16mjegz42kg.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_62sz8m16rjegz42kn.fromContextToolbars(toolbars);
    result = $_8xxv0d16ojegz42ki.match(editor, [
      $_9s950p16njegz42kh.element(elements[0], contextToolbarsPredicateIds),
      $_7inede16tjegz42kp.textSelection('text'),
      $_7inede16tjegz42kp.emptyTextBlock(elements, 'insert'),
      $_9s950p16njegz42kh.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_8xxv0d16ojegz42ki.match(editor, [$_7inede16tjegz42kp.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_2ilimq16ujegz42kr.load(editor, function () {
  ...
  var $_f86pkr16ijegz42kc = { renderUI: renderUI };
  ...
  var never$1 = $_8gn5b2175jegz42ly.never;
  var always$1 = $_8gn5b2175jegz42ly.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_8gn5b2175jegz42ly.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_6a3v3h17cjegz42n0.parseBox(settings.border);
      self.paddingBox = $_6a3v3h17cjegz42n0.parseBox(settings.padding);
      self.marginBox = $_6a3v3h17cjegz42n0.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_8fbw9817kjegz42nr.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_6a3v3h17cjegz42n0.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_6a3v3h17cjegz42n0.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_6a3v3h17cjegz42n0.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_23uqw917jjegz42nq.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_8fbw9817kjegz42nr.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_8fbw9817kjegz42nr.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_35u77o17ljegz42o8 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_8fbw9817kjegz42nr.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_8fbw9817kjegz42nr.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_7a2o0j173jegz42l7.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_7a2o0j173jegz42l7.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_6a3v3h17cjegz42n0.parseBox(self.settings.border);
          ...
          self.borderBox = $_6a3v3h17cjegz42n0.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_f86pkr16ijegz42kc.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_bop8be16hjegz42ka = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_5mkv6f184jegz42qg.resolve(name, scope);
  };
  ...
  var $_f9ti06183jegz42qe = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_f9ti06183jegz42qe.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_ettoxl181jegz42qa = { blobToBase64: blobToBase64 };
  ...
  var $_7lvl5i187jegz42qj = { pickFile: pickFile };
  ...
  var $_2dx9mg189jegz42qo = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_aq9oib18bjegz42qt.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_aq9oib18bjegz42qt.resolve(dom, bookmark));
  };
  ...
  var $_1g6pol18ajegz42qq = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_2dx9mg189jegz42qo.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_1g6pol18ajegz42qq.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_17c1p1188jegz42ql.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_7lvl5i187jegz42qj.pickFile().then(function (files) {
          var blob = files[0];
          $_ettoxl181jegz42qa.blobToBase64(blob).then(function (base64) {
            $_17c1p1188jegz42ql.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_17c1p1188jegz42ql.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_3idfad180jegz42q8 = { addToEditor: addToEditor };
  ...
  var $_abqoz418fjegz42r2 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_c9frcn18hjegz42r9.isAbsolute(href) && $_c9frcn18hjegz42r9.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_17c1p1188jegz42ql.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_17c1p1188jegz42ql.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_13nnlx18gjegz42r6 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_91psyw16zjegz42kx.isArray(items)) {
      return items;
    } else if ($_91psyw16zjegz42kx.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    Tools.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_91psyw16zjegz42kx.isFunction(button)) {
            button = button();
          }
  ...
  var $_7fohwo18ijegz42ra = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_7fohwo18ijegz42ra.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_7fohwo18ijegz42ra.create(editor, 'text', $_1i86a16wjegz42kt.getTextSelectionToolbarItems(editor)),
        $_7fohwo18ijegz42ra.create(editor, 'insert', $_1i86a16wjegz42kt.getInsertToolbarItems(editor)),
        $_13nnlx18gjegz42r6.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_1i86a16wjegz42kt.getPositionHandler(editor);
      contentAreaRect = $_2pgzdr16pjegz42kk.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_el3x33170jegz42kz.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_el3x33170jegz42kz.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_abqoz418fjegz42r2.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_el3x33170jegz42kz.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_2pgzdr16pjegz42kk.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_el3x33170jegz42kz.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_el3x33170jegz42kz.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_9k4dkk16vjegz42ks.fireBeforeRenderUI(editor);
  ...
  var $_ombf3195jegz42tt = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_8gn5b2175jegz42ly.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_9i6i02196jegz42tv = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_dp79xo19ajegz42u6 = { cached: cached };

  var $_9torhi19cjegz42um = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_9torhi19cjegz42um.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_9torhi19cjegz42um.ELEMENT);
  var isText = isType$1($_9torhi19cjegz42um.TEXT);
  var isDocument = isType$1($_9torhi19cjegz42um.DOCUMENT);
  var $_7p904619bjegz42uk = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_7p904619bjegz42uk.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_dp79xo19ajegz42u6.cached(function () {
    return getBody($_9i6i02196jegz42tv.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_9i6i02196jegz42tv.fromDom(body);
  };
  var $_fdtj9a199jegz42u4 = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_7a2o0j173jegz42l7.each(fields, function (name, i) {
        struct[name] = $_8gn5b2175jegz42ly.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_8x998p19ejegz42uw.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_7a2o0j173jegz42l7.each(array, function (a) {
      if (!$_8x998p19ejegz42uw.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_7a2o0j173jegz42l7.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_gcgq3019jjegz42v4.validateStrArr('required', required);
    $_gcgq3019jjegz42v4.validateStrArr('optional', optional);
    $_gcgq3019jjegz42v4.checkDupes(everything);
    return function (obj) {
      var keys = $_4h65uv19ijegz42v2.keys(obj);
      var allReqd = $_7a2o0j173jegz42l7.forall(required, function (req) {
        return $_7a2o0j173jegz42l7.contains(keys, req);
      });
      if (!allReqd)
        $_gcgq3019jjegz42v4.reqMessage(required, keys);
      var unsupported = $_7a2o0j173jegz42l7.filter(keys, function (key) {
        return !$_7a2o0j173jegz42l7.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_gcgq3019jjegz42v4.unsuppMessage(unsupported);
      var r = {};
      $_7a2o0j173jegz42l7.each(required, function (req) {
        r[req] = $_8gn5b2175jegz42ly.constant(obj[req]);
      });
      $_7a2o0j173jegz42l7.each(optional, function (opt) {
        r[opt] = $_8gn5b2175jegz42ly.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_9c3cc619fjegz42ux = {
    immutable: Immutable,
  ...
  var $_ctskm219kjegz42v6 = { toArray: toArray };

  var node = function () {
    var f = $_f9ti06183jegz42qe.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_ei1fqb19qjegz42vk.unknown()
    });
  };
  ...
  var $_363eu919pjegz42vh = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_8gn5b2175jegz42ly.constant(edge),
    chrome: $_8gn5b2175jegz42ly.constant(chrome),
    ie: $_8gn5b2175jegz42ly.constant(ie),
    opera: $_8gn5b2175jegz42ly.constant(opera),
    firefox: $_8gn5b2175jegz42ly.constant(firefox),
    safari: $_8gn5b2175jegz42ly.constant(safari)
  };
  ...
  var $_7rr2d719rjegz42vl = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_8gn5b2175jegz42ly.constant(windows$1),
    ios: $_8gn5b2175jegz42ly.constant(ios),
    android: $_8gn5b2175jegz42ly.constant(android),
    linux: $_8gn5b2175jegz42ly.constant(linux),
    osx: $_8gn5b2175jegz42ly.constant(osx),
    solaris: $_8gn5b2175jegz42ly.constant(solaris),
    freebsd: $_8gn5b2175jegz42ly.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_8gn5b2175jegz42ly.constant(isiPad),
      isiPhone: $_8gn5b2175jegz42ly.constant(isiPhone),
      isTablet: $_8gn5b2175jegz42ly.constant(isTablet),
      isPhone: $_8gn5b2175jegz42ly.constant(isPhone),
      isTouch: $_8gn5b2175jegz42ly.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_8gn5b2175jegz42ly.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_7a2o0j173jegz42l7.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_ei1fqb19qjegz42vk.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_ei1fqb19qjegz42vk.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_g3ykbt19wjegz42w3.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_g3ykbt19wjegz42w3.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_g3ykbt19wjegz42w3.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_g3ykbt19wjegz42w3.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_bntpgj19xjegz42w4.head(str).bind(function (head) {
      return $_bntpgj19xjegz42w4.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_aya2tc19vjegz42w1.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_aya2tc19vjegz42w1.contains(uastring, 'edge/') && $_aya2tc19vjegz42w1.contains(uastring, 'chrome') && $_aya2tc19vjegz42w1.contains(uastring, 'safari') && $_aya2tc19vjegz42w1.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_aya2tc19vjegz42w1.contains(uastring, 'chrome') && !$_aya2tc19vjegz42w1.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_aya2tc19vjegz42w1.contains(uastring, 'msie') || $_aya2tc19vjegz42w1.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_aya2tc19vjegz42w1.contains(uastring, 'safari') || $_aya2tc19vjegz42w1.contains(uastring, 'mobile/')) && $_aya2tc19vjegz42w1.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_aya2tc19vjegz42w1.contains(uastring, 'iphone') || $_aya2tc19vjegz42w1.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_cifiem19ujegz42vv = {
    browsers: $_8gn5b2175jegz42ly.constant(browsers),
    oses: $_8gn5b2175jegz42ly.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_cifiem19ujegz42vv.browsers();
    var oses = $_cifiem19ujegz42vv.oses();
    var browser = $_8ysqd419tjegz42vr.detectBrowser(browsers, userAgent).fold($_363eu919pjegz42vh.unknown, $_363eu919pjegz42vh.nu);
    var os = $_8ysqd419tjegz42vr.detectOs(oses, userAgent).fold($_7rr2d719rjegz42vl.unknown, $_7rr2d719rjegz42vl.nu);
  ...
  var $_9cwsc319ojegz42vg = { detect: detect$2 };

  var detect$3 = $_dp79xo19ajegz42u6.cached(function () {
    var userAgent = navigator.userAgent;
    return $_9cwsc319ojegz42vg.detect(userAgent);
  });
  var $_bcgk8919njegz42ve = { detect: detect$3 };

  var ELEMENT = $_9torhi19cjegz42um.ELEMENT;
  var DOCUMENT = $_9torhi19cjegz42um.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_7a2o0j173jegz42l7.map(base.querySelectorAll(selector), $_9i6i02196jegz42tv.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_9i6i02196jegz42tv.fromDom);
  };
  var $_uhae119yjegz42w6 = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_7a2o0j173jegz42l7.exists(elements, $_8gn5b2175jegz42ly.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_b8m0g319mjegz42vd.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_bcgk8919njegz42ve.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_dcez7x19ljegz42v7 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_uhae119yjegz42w6.is
  };

  var owner = function (element) {
    return $_9i6i02196jegz42tv.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_9i6i02196jegz42tv.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_9i6i02196jegz42tv.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_9i6i02196jegz42tv.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_7a2o0j173jegz42l7.findIndex(kin, function (elem) {
        return $_dcez7x19ljegz42v7.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_8x998p19ejegz42uw.isFunction(isRoot) ? isRoot : $_8gn5b2175jegz42ly.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_9i6i02196jegz42tv.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_7a2o0j173jegz42l7.filter(elements, function (x) {
        return !$_dcez7x19ljegz42v7.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_9i6i02196jegz42tv.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_9i6i02196jegz42tv.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_9i6i02196jegz42tv.fromDom);
  };
  var prevSiblings = function (element) {
    return $_7a2o0j173jegz42l7.reverse($_ctskm219kjegz42v6.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_ctskm219kjegz42v6.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_7a2o0j173jegz42l7.map(dom.childNodes, $_9i6i02196jegz42tv.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_9i6i02196jegz42tv.fromDom);
  };
  ...
  var spot = $_9c3cc619fjegz42ux.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_dlqx7c19djegz42uo = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_fdtj9a199jegz42u4.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_7a2o0j173jegz42l7.filter($_dlqx7c19djegz42uo.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_7a2o0j173jegz42l7.filter($_dlqx7c19djegz42uo.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_7a2o0j173jegz42l7.filter($_dlqx7c19djegz42uo.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_7a2o0j173jegz42l7.each($_dlqx7c19djegz42uo.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_uhae119yjegz42w6.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_7lqrpi198jegz42u1.ancestors(scope, function (e) {
      return $_uhae119yjegz42w6.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_7lqrpi198jegz42u1.siblings(scope, function (e) {
      return $_uhae119yjegz42w6.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_7lqrpi198jegz42u1.children(scope, function (e) {
      return $_uhae119yjegz42w6.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_uhae119yjegz42w6.all(selector, scope);
  };
  var $_7gfs80197jegz42tz = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_7a2o0j173jegz42l7.map($_7gfs80197jegz42tz.descendants($_9i6i02196jegz42tv.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_ombf3195jegz42tt.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_8gn5b2175jegz42ly.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_7a2o0j173jegz42l7.map($_7a2o0j173jegz42l7.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_7a2o0j173jegz42l7.map($_7a2o0j173jegz42l7.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_7a2o0j173jegz42l7.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_1o6nta194jegz42tl = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_8gn5b2175jegz42ly.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_7a2o0j173jegz42l7.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_7a2o0j173jegz42l7.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_7a2o0j173jegz42l7.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_7a2o0j173jegz42l7.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_7a2o0j173jegz42l7.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_1o6nta194jegz42tl.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_8x998p19ejegz42uw.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_fdtj9a199jegz42u4.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_9i6i02196jegz42tv.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_9i6i02196jegz42tv.fromDom(element.parentNode), function (x) {
      return !$_dcez7x19ljegz42v7.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_7a2o0j173jegz42l7.find(scope.dom().childNodes, $_8gn5b2175jegz42ly.compose(predicate, $_9i6i02196jegz42tv.fromDom));
    return result.map($_9i6i02196jegz42tv.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_9i6i02196jegz42tv.fromDom(element.childNodes[i])))
          return Option.some($_9i6i02196jegz42tv.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_uhae119yjegz42w6.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_8ocy9z1a4jegz42wy.ancestor(scope, function (e) {
      return $_uhae119yjegz42w6.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_8ocy9z1a4jegz42wy.sibling(scope, function (e) {
      return $_uhae119yjegz42w6.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_8ocy9z1a4jegz42wy.child(scope, function (e) {
      return $_uhae119yjegz42w6.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_uhae119yjegz42w6.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_uhae119yjegz42w6.is, ancestor$1, scope, selector, isRoot);
  };
  var $_a40le81a3jegz42ww = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_csaqbc1a7jegz42xa.postRenderFormat(editor, name)
      });
    });
  };
  var $_gfx3831a6jegz42x9 = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_9i6i02196jegz42tv.fromDom).filter($_7p904619bjegz42uk.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_f57n1n1a9jegz42xf = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_8gn5b2175jegz42ly.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_f57n1n1a9jegz42xf.getFontFamily(editor.getBody(), e.element);
  ...
  var $_cstk8i1a8jegz42xc = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_f57n1n1a9jegz42xf.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_f57n1n1a9jegz42xf.toPt(px, precision);
  ...
  var $_7124eh1aajegz42xj = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_csaqbc1a7jegz42xa.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_5ws87b1abjegz42xm = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_csaqbc1a7jegz42xa.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_dq62dv1acjegz42xp = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_7a2o0j173jegz42l7.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_7a2o0j173jegz42l7.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_7a2o0j173jegz42l7.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_bu8yig1adjegz42xs = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_csaqbc1a7jegz42xa.postRenderFormat(editor, name),
        onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_csaqbc1a7jegz42xa.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_ccpur91aejegz42xv = { register: register$6 };
  ...
  var $_52um3z1afjegz42xx = { register: register$7 };
  ...
  var $_4i1b751agjegz42xy = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_a40le81a3jegz42ww.descendant($_9i6i02196jegz42tv.fromDom(document.body), editor.settings.ui_container).fold($_8gn5b2175jegz42ly.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_dq62dv1acjegz42xp.register(editor);
    $_gfx3831a6jegz42x9.register(editor);
    $_ccpur91aejegz42xv.register(editor);
    $_52um3z1afjegz42xx.register(editor);
    $_7124eh1aajegz42xj.register(editor);
    $_cstk8i1a8jegz42xc.register(editor);
    $_5ws87b1abjegz42xm.register(editor);
    $_4i1b751agjegz42xy.register(editor);
    $_bu8yig1adjegz42xs.register(editor);
  };
  var $_49l3ut1a2jegz42ws = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_8x998p19ejegz42uw.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_8x998p19ejegz42uw.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_23uqw917jjegz42nq,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_2u7t6m17xjegz42pm,
      Panel: Panel,
      Movable: $_35u77o17ljegz42o8,
      Resizable: $_3ktgow17yjegz42pp,
      ...
      FormatControls: $_49l3ut1a2jegz42ws,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = create$3();
    $_49l3ut1a2jegz42ws.setup(editor);
    $_3idfad180jegz42q8.addToEditor(editor, panel);
    return $_bop8be16hjegz42ka.get(editor, panel);
  });
  function Theme () {
  }
