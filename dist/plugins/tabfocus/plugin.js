...
var tabfocus = (function () {
  ...
  var $_f7h5i6jmjegz3xto = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_f7h5i6jmjegz3xto.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_8mpnz4jfjegz3xtf = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_8mpnz4jfjegz3xtf.setup(editor);
  });
  function Plugin () {
  }
