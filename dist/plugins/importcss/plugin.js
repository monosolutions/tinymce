...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_2ihfvle5jegz3www.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_2ihfvle5jegz3www.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_2ihfvle5jegz3www.getSelectorConverter(editor)) {
      selectorConverter = $_2ihfvle5jegz3www.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_2ihfvle5jegz3www.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_2ihfvle5jegz3www.getCssGroups(editor));
      ...
      if (!$_2ihfvle5jegz3www.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_2ihfvle5jegz3www.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_7bs2f4e0jegz3wwm.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_y5ds3dzjegz3wwj = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_7bs2f4e0jegz3wwm.setup(editor);
    return $_y5ds3dzjegz3wwj.get(editor);
  });
  function Plugin () {
  }
