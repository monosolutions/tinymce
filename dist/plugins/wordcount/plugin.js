...
var wordcount = (function () {
  ...
  var $_geuaxls8jegz3zl2 = {
    each: each,
    map: map
  };

  var SETS$1 = $_3v1jl1s6jegz3zkw.SETS;
  var OTHER = $_3v1jl1s6jegz3zkw.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_geuaxls8jegz3zl2.map(string.split(''), memoized);
  };
  var $_1sdcqus7jegz3zl0 = { classify: classify };

  var ci = $_3v1jl1s6jegz3zkw.characterIndices;
  ...
  var $_bqi7hqs9jegz3zl3 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_3v1jl1s6jegz3zkw.EMPTY_STRING;
  var WHITESPACE$1 = $_3v1jl1s6jegz3zkw.WHITESPACE;
  var PUNCTUATION$1 = $_3v1jl1s6jegz3zkw.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_1sdcqus7jegz3zl0.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_bqi7hqs9jegz3zl3.isWordBoundary(map, i)) {
  ...
  var $_9a1iwds5jegz3zkt = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_9a1iwds5jegz3zkt.getWords(getTextContent(editor)).length;
  };
  var $_ao990ds4jegz3zkq = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_ao990ds4jegz3zkq.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_9mtyws3jegz3zko = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_ao990ds4jegz3zkq.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_3oodj6sajegz3zl6 = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_3oodj6sajegz3zl6.setup(editor);
    return $_9mtyws3jegz3zko.get(editor);
  });
  function Plugin () {
  }
