...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_9vfrmb8cjegz3vn5.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_9vfrmb8cjegz3vn5.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_9vfrmb8cjegz3vn5.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_9vfrmb8cjegz3vn5.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_9vfrmb8cjegz3vn5.getAutoResizeBottomMargin(editor);
    ...
    if ($_9vfrmb8cjegz3vn5.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_73sqm489jegz3vmz.resize(editor, oldSize);
    });
  };
  var $_59mrdw88jegz3vmx = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_59mrdw88jegz3vmx.register(editor, oldSize);
      $_73sqm489jegz3vmz.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
