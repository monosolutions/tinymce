...
var emoticons = (function () {
  ...
  var $_1sfovnahjegz3vzd = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_1sfovnahjegz3vzd.getHtml(pluginUrl);
  ...
  var $_5fnc2yagjegz3vzc = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_5fnc2yagjegz3vzc.register(editor, pluginUrl);
  });
  function Plugin () {
  }
