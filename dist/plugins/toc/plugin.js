...
var toc = (function () {
  ...
  var $_8efmlcr2jegz3zfk = { create: create };

  var tocId = $_8efmlcr2jegz3zfk.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_6nd27yr1jegz3zfj.getTocClass(editor);
    var headerTag = $_6nd27yr1jegz3zfj.getTocHeader(editor);
    var selector = generateSelector($_6nd27yr1jegz3zfj.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_6nd27yr1jegz3zfj.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_6nd27yr1jegz3zfj.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_fpw3bjqxjegz3zfe.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_fpw3bjqxjegz3zfe.updateToc(editor);
    });
  };
  var $_51a4b5qwjegz3zfc = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_6nd27yr1jegz3zfj.getTocClass(editor);
  ...
  var $_67pngyr3jegz3zfl = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_fpw3bjqxjegz3zfe.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_6nd27yr1jegz3zfj.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_cp2bur4jegz3zfq = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_51a4b5qwjegz3zfc.register(editor);
    $_cp2bur4jegz3zfq.register(editor);
    $_67pngyr3jegz3zfl.setup(editor);
  });
  function Plugin () {
  }
