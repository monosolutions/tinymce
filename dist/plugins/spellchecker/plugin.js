...
var spellchecker = (function () {
  ...
  var $_d9b0meizjegz3xp7 = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_74dzb1j1jegz3xpb.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_74dzb1j1jegz3xpb.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_74dzb1j1jegz3xpb.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_mwexij6jegz3xpo.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_74dzb1j1jegz3xpb.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_mwexij6jegz3xpo.fireSpellcheckStart(editor);
  };
  var $_7zrln5j2jegz3xpf = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_74dzb1j1jegz3xpb.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_74dzb1j1jegz3xpb.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_7zrln5j2jegz3xpf.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_77erfj0jegz3xp9 = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_7zrln5j2jegz3xpf.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_d664x5j8jegz3xq8 = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_74dzb1j1jegz3xpb.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_74dzb1j1jegz3xpb.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_c3dpasj9jegz3xqb = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_7zrln5j2jegz3xpf.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_7zrln5j2jegz3xpf.addToDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_7zrln5j2jegz3xpf.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_7zrln5j2jegz3xpf.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_7zrln5j2jegz3xpf.findSpansByIndex(editor, $_7zrln5j2jegz3xpf.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_5u5qr0jajegz3xqf = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_d9b0meizjegz3xp7.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_74dzb1j1jegz3xpb.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_c3dpasj9jegz3xqb.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_5u5qr0jajegz3xqf.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState);
      $_d664x5j8jegz3xq8.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_77erfj0jegz3xp9.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  function Plugin () {
  }
