...
var help = (function () {
  ...
  var never$1 = $_de7jojaqjegz3w1k.never;
  var always$1 = $_de7jojaqjegz3w1k.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_de7jojaqjegz3w1k.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_87cja3asjegz3w1p = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_6bqj6vaojegz3w0h.map($_87cja3asjegz3w1p.shortcuts, function (shortcut) {
  ...
  var $_20od4banjegz3w08 = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_fkwgsqaxjegz3w2e.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_fkwgsqaxjegz3w2e.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_fkwgsqaxjegz3w2e.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_fkwgsqaxjegz3w2e.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_b9mxrpayjegz3w2f.head(str).bind(function (head) {
      return $_b9mxrpayjegz3w2f.tail(str).map(function (tail) {
  ...
  var $_9ng2aoazjegz3w2i = { urls: urls };

  var makeLink = $_de7jojaqjegz3w1k.curry($_7pwfnpawjegz3w28.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_6bqj6vaojegz3w0h.find($_9ng2aoazjegz3w2i.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_a9z1tzavjegz3w25.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_6bqj6vaojegz3w0h.filter(keys, $_de7jojaqjegz3w1k.not($_de7jojaqjegz3w1k.curry($_6bqj6vaojegz3w0h.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_6bqj6vaojegz3w0h.map(pluginKeys, function (key) {
  ...
  var $_6rvd34aujegz3w1s = { makeTab: makeTab$1 };
  ...
  var $_2gg5tab0jegz3w2l = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_20od4banjegz3w08.makeTab(),
          $_6rvd34aujegz3w1s.makeTab(editor)
        ],
        buttons: $_2gg5tab0jegz3w2l.makeRow(),
  ...
  var $_2w6dseamjegz3w05 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_2w6dseamjegz3w05.open(editor, pluginUrl));
  };
  var $_8t8m34aljegz3w03 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_2w6dseamjegz3w05.open(editor, pluginUrl)
    });
  ...
  var $_m39ywb2jegz3w2n = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_m39ywb2jegz3w2n.register(editor, pluginUrl);
    $_8t8m34aljegz3w03.register(editor, pluginUrl);
